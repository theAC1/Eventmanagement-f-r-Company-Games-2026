# Auf dem Homelab ausfuehren, in /home/deploy/company-games-2026.
# Kompletten Block markieren und ins SSH-Terminal einfuegen.
# Reines SELECT - schreibt nichts in die DB.

docker compose exec -T db psql -U cg26 -d companygames -t -A -f /dev/stdin > games-export.json <<'EXPORT_SQL'
...
# Kontrolle: wie viele Games sind drin?
grep -c '"slug"' games-export.json
